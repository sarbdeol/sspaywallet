    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          <div style={{
            width: 52, height: 52, borderRadius: 16, background: '#1a1a2e',
            display: 'inline-flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16,
          }}>
            <CreditCard size={24} color="#fff" />
          </div>
          <h1 style={{ fontSize: 24, fontWeight: 700, color: '#111827', marginBottom: 4 }}>SSPay Wallet</h1>
        ...
        <div style={{
          ...
          boxShadow: '0 4px 20px rgba(0,0,0,.06)', padding: 32,
        }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  required
                  style={{
                    width: '100%', padding: '8px 40px 8px 12px', fontSize: 14,
                    border: '1.5px solid #e4e4e7', borderRadius: 10, outline: 'none',
                    background: '#fff', fontFamily: 'DM Sans, sans-serif', color: '#1f2937',
                  }}
