...
export default function AdminLedger() {
  ...
  function exportPDF() {
    ...
    doc.text(
      `Wallet Balance: ${fmtINR(wallet?.balance)}  |  Generated: ${new Date().toLocaleString("en-IN")}`,
      14,
      28,
    );
    if (dateFrom || dateTo)
    ...
    autoTable(doc, {
      ...
      foot: [
        [
          ...
          "",
          "Total",
          parseFloat(totalAmt).toLocaleString("en-IN", {
            minimumFractionDigits: 2,
          }),
          "",
          "",
            ...
            >
              ...
              >
                ...
                <span style={{ fontWeight: 500, color: "#111827" }}>
                  {selUser?.full_name || selUser?.username}
                </span>
                <span style={{ color: "#9ca3af", margin: "0 8px" }}>·</span>
                <span style={{ color: "#9ca3af" }}>
                  {txns.length} transactions · {fmtINR(totalAmt)}
                </span>
              </div>

              {[
                {
                  label: "Send to (Email or WhatsApp)",
