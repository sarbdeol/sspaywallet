...
export default function ApiKeys() {
  ...
  const maskedKey = apiInfo?.api_key
    ? apiInfo.api_key.slice(0, 12) +
      "••••••••••••••••••••••••••••" +
      apiInfo.api_key.slice(-4)
    : "—";
  ...
  return (
    <div>
      <PageHeader
        title="API Keys"
        subtitle="Use your API key to create payouts programmatically"
      />
      ...
      <Card style={{ padding: 24, marginBottom: 20 }}>
        ...
        >
          ...
          <button
            onClick={() => copy(apiInfo?.api_key, "API key")}
            style={{
              background: "none",
              border: "1px solid #e4e4e7",
              cursor: "pointer",
        ...
        <div style={{ fontSize: 12, color: "#9ca3af" }}>
          ⚠️ Never expose this key in frontend code. Always call from your
          backend server.
        </div>
      </Card>
      ...
      <Card style={{ padding: 24, marginBottom: 20 }}>
        ...
        >
          {[
            ...
            {
              label: "Check Status",
              value: "GET /api/v1/public/payout/status/:order_id",
            },
      ...
      <Card style={{ padding: 24, marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 13, color: "#6b7280", marginBottom: 16 }}>
          XPay will POST to this URL when a payout succeeds or fails. Signed
          with{" "}
          <code
            style={{
              fontFamily: "DM Mono, monospace",
