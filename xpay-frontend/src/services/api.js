...
export const adminApi = {
  ...
  regenerateApiKey:   (uid)      => api.patch(`/admin/wallets/${uid}/regenerate-api-key`),
  toggleApiAccess:    (uid)      => api.patch(`/admin/wallets/${uid}/toggle-api-access`),
...
export const payoutApi = {
  ...
  getApiInfo:       ()       => api.get('/public/api-info'),
